$(document).ready(function(){
	function creatBaseCss(){
		...
		cssHtml+='';
		cssHtml+='.pub-littlt-fix-nav {   position: fixed;   left: 50%;   margin-left: 500px;   bottom: 80px;   width: 40px;   display: block;   _display: none;   user-select: none;   -webkit-user-select: none;   -moz-user-select: none;   -ms-user-select: none;   z-index:15; }';
		...
		cssHtml+='.pub-littlt-fix-nav .client{ 	background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.png) no-repeat 0px -40px; 	_background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.gif) no-repeat 0px -40px; 	background-color: #fff; 	visibility: visible; 	position:relative; }';
		...
		cssHtml+='.pub-littlt-fix-nav .client .close{ 	width:23px; 	height:23px; 	position:absolute; 	right:-1px; 	top:-24px; 	background:#fff url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.png) no-repeat -8px 4px; 	_background:#fff url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.gif) no-repeat -8px 4px; 	border:1px solid #e0e0e0; 	border-bottom:0; 	cursor:pointer; }';
		cssHtml+='.pub-littlt-fix-nav .client .cor{ 	width:60px; 	height:8px; 	position:absolute; 	left:40px; 	bottom:-8px; 	background:url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.png) no-repeat 10px -315px; 	_background:#fff url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.gif) no-repeat 10px -315px; }';
		cssHtml+='.pub-littlt-fix-nav .to-top.show{ 	background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.png) no-repeat 0 -162px; 	_background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.gif) no-repeat 0 -162px; 	background-color: #fff; 	visibility: visible; }';
		...
		cssHtml+='.pub-littlt-fix-nav .suggest {   background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.png) no-repeat 1px -81px;   _background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.gif) no-repeat 1px -81px;   background-color: #fff;   position:relative; }';
		cssHtml+='.pub-littlt-fix-nav .share {    background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.png) no-repeat 1px -122px;   _background: url(http://www.9game.cn/public/images/pc/pc_9game_public/litnav/litt_nav.gif) no-repeat 1px -122px;   background-color: #fff; }';
